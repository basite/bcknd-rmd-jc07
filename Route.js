// - Problem  : 
            // Buatlah sebuah aplikasi NodeJS (Express) sederhana yang mampu mengakses database "Plantae" (MySQL)
            // dan database "Animalia" (MongoDB), dengan spesifikasi sebagai berikut:
            // GET /flora/monokotil → akan memberikan response: menampilkan semua data dari tabel "Monocotyledon".
            // GET /flora/dikotil → akan memberikan response: menampilkan semua data dari tabel "Dicotyledon".
            // GET /fauna/vertebrata → akan memberikan response: menampilkan semua data dari collection "Vertebrata".
            // GET /fauna/invertebrata → akan memberikan response: menampilkan semua data dari collection "Invertebrata".
// - Todo     : 
